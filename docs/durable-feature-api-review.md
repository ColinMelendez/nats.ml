...
live cluster and failure-injection matrices have passed.
...
- live KV and Object Store cluster/failure-injection coverage remains outside
  the local mock suite;
...
- The cross-SDK Object Store matrix passes anonymous, token,
  ...
  NATS server releases; broader cluster coverage remains in `plan.md`.
