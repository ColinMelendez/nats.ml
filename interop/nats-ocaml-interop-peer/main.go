...
func main() {
	...
	flag.StringVar(&config.mode, "mode", "core", "interop mode: core, service, reconnect, service-reconnect, jetstream, jetstream-admin, jetstream-push, jetstream-ordered, jetstream-kv, jetstream-object, jetstream-push-reconnect, jetstream-ordered-reconnect, jetstream-ordered-restart, or jetstream-ordered-leader-failover")
	flag.Parse()
